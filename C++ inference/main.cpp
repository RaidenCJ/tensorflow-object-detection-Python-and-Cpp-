...
int main(int argc, char* argv[]) {
    ...
    // Set dirs variables
    string ROOTDIR = "../";
    string LABELS = "ssv_data/labels_map.pbtxt";
    string GRAPH = "ssv_data/frozen_inference_graph.pb";
    ...
    cap_video.open(argv[1]);

    tensorflow::TensorShape shape = tensorflow::TensorShape();
    shape.AddDim(1);
    shape.AddDim((int64)cap_video.get(CAP_PROP_FRAME_HEIGHT));
    shape.AddDim((int64)cap_video.get(CAP_PROP_FRAME_WIDTH));
    shape.AddDim(3);
